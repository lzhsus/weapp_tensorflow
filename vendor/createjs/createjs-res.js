...
function Loader(cls,loaderNum, link = false) {
  ...
  this.init = function() {
    promise = new Promise(function(resolve, reject) {
      ...
      switch(canvasCls){
        case "bg":
            canvas = require("../../flash/static/bg.js");
            if (!link) {
                lib = require("../../flash/bg.js");
            }
            break;
        case "config":
            if (!link) {
                lib = require("../../flash/config.js");
            }
            break;
        case "loading":
            canvas = require("../../flash/static/loading.js");
            if (!link) {
                lib = require("../../flash/loading.js");
            }
            break;
        case "nav":
            canvas = require("../../flash/static/nav.js");
            if (!link) {
                lib = require("../../flash/nav.js");
            }
            break;
        case "layer01":
            canvas = require("../../flash/static/layer01.js");
            if (!link) {
                lib = require("../../flash/layer01.js");
            }
            break;
        case "layer02":
            canvas = require("../../flash/static/layer02.js");
            if (!link) {
                lib = require("../../flash/layer02.js");
            }
            break;
        case "layer03":
            canvas = require("../../flash/static/layer03.js");
            if (!link) {
                lib = require("../../flash/layer03.js");
            }
            break;
        case "layer04":
            canvas = require("../../flash/static/layer04.js");
            if (!link) {
                lib = require("../../flash/layer04.js");
            }
            break;
        case "empty":
            canvas = require("../../flash/static/empty.js");
            if (!link) {
                lib = require("../../flash/empty.js");
            }
            break;
    }
  ...
  function startLoad(id) {
    ...
    for (let i = id; i < resLength && i < id + preloadNum; i++) {
      ...
      let src = appConfig[appConfig.envVersion].serverPathQH+'gululuweapp/' + resArr[i]["src"];
      imgObj.src = src.indexOf('?')==-1?src+'?v=202012221013':src+'&v=202012221013';
    }
  }
...
function Flash(canvas) {
  ...
  this.handleEvent=function(e){
    createjs.Touch._IOS_handleEvent(stage,e);
  }
  ...
  this.destory=function(){
    ...
    topContent.removeAllChildren();
    bottomContent.removeAllChildren();
    loadingContent.removeAllChildren();
